...
export default function AddDevice({ open, searching = true, found, failed, onDevice, handleSubmit, handleClose }) {
    return (
        <Modal open={open} handleSubmit={handleSubmit} handleClose={handleClose} title={"ADD DEVICE"}
            ...
            <div className={classNames(styles.container)}>
                <CircularProgress size={394} sx={{ opacity: 0.3 }} variant={failed ? "determinate" : searching ? "indeterminate" : ""} value={0} />
